<script lang="ts">
	...
	import { closeSearch, openInfo, getInfo, openService } from '../services/commands';
...
<main>
	<Search {service} {isFocused} on:newValues={handleNewValues} />
	<List {items} {service} {shortcuts} {currentSelection} />
</main>
